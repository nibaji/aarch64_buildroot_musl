...
#define __GMP_CC "/run/media/nibaji/529BDE4958CF94A7/aarch64-nibaji-gcc-prebuilt/host/bin/ccache /usr/lib64/ccache/gcc"
#define __GMP_CFLAGS "-O2 -I/run/media/nibaji/529BDE4958CF94A7/aarch64-nibaji-gcc-prebuilt/host/include"
